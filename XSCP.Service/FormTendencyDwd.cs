...
namespace XSCP.Service
{
    public partial class FormTendencyDwd : Form
    {
        ...
        public DwdTendency DwdTendency1;
        public DwdTendency DwdTendency2;
        ...
        {
            DgvController.AddRows(this.dgv1, DwdTendency1.Lt_Dwds.Count);

            List<DwdTendencyModel> Lt_Dwds1 = DwdTendency1.Lt_Dwds.OrderByDescending(l => l.Sno).ToList();
            List<DwdTendencyModel> Lt_Dwds2 = DwdTendency2.Lt_Dwds.OrderByDescending(l => l.Sno).ToList();

            DwdTendencyModel tm1;
            DwdTendencyModel tm2;
