...
namespace XSCP.Service.Dbole
{
    ...
    public abstract class DbHelperOleDb
    {
        ...
        //public static string connectionString = SysConfig.Config.Items.ConnectionString + SysConfig.AppBasePath + SysConfig.Config.Items.DataSource;
        public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0 ;Data Source=" + SysConfig.AppBasePath + "\\datasource\\XSCP.mdb;Persist Security Info=False";
