...
namespace XSCP.Service.Controllers
{
    public class AnalyzeTendencyUnit
    {
        ...
        private Type type = typeof(TendencyModel);
        ...
        public void SetTendencyUnits(List<TendencyModel> lt, EnumNumberType numberType, EnumSelectType selectType)
        {
        ...
        private void TendencyUnits选1(List<TendencyModel> lt, EnumNumberType numberType)
        {
        ...
        private void getTendencyUnit(List<TendencyModel> lt, List<TendencyType> lt_names)
        {
        ...
        #region 组合
        public int GetUnitValue(List<TendencyModel> lt, int index, string propertyName1, string propertyName2)
        {
            TendencyModel tm;
            int pre = lt.Count;
