...
namespace XSCP.Common
{
    ...
    public class XscpSqlliteBLL
    {
        ...
        public static bool Update(DateTime dt, List<string> ltData)
        {
            ...
            {
                ///新增开奖号码
                List<LotteryModel> lt_LotteryModel = XscpSqlliteBLL.SaveLottery(dt, ltData);

                ///新增一星走势
                XscpSqlliteBLL.SaveTendency1(Tendency1Enum.TenThousand, lt_LotteryModel);
                XscpSqlliteBLL.SaveTendency1(Tendency1Enum.Thousand, lt_LotteryModel);
                XscpSqlliteBLL.SaveTendency1(Tendency1Enum.Hundred, lt_LotteryModel);
                XscpSqlliteBLL.SaveTendency1(Tendency1Enum.Ten, lt_LotteryModel);
                XscpSqlliteBLL.SaveTendency1(Tendency1Enum.One, lt_LotteryModel);

                ///新增二星走势
                XscpSqlliteBLL.SaveTendency2(Tendency2Enum.Before, lt_LotteryModel);
                XscpSqlliteBLL.SaveTendency2(Tendency2Enum.After, lt_LotteryModel);
                return true;
            }
            catch (Exception er)
            {
        ...
        {
            return SQLiteHelper.QueryDateList();
        }
